...
__all__ = [
    'DISPID_SRDisplayUI', 'SpeechUserTraining', 'SPEI_WORD_BOUNDARY',
    'SPRS_INACTIVE', 'SRESoundStart', 'SpeechTokenValueCLSID',
    'SpeechVoiceCategoryTTSRate', 'SREStateChange',
    'DISPID_SPRulesItem', 'DISPID_SRCRequestedUIType',
    'DISPID_SRRAlternates', 'SPSHT_NotOverriden', 'DISPID_SAFGuid',
    'ISpStreamFormat', 'DISPID_SGRs_NewEnum',
    'SpeechTokenIdUserLexicon', 'SVEAllEvents',
    'SPEI_SENTENCE_BOUNDARY', 'ISpRecoCategory',
    'DISPID_SPPs_NewEnum', 'eLEXTYPE_MORPHOLOGY', 'IStream',
    'DISPID_SGRsCommit', 'SpeechGrammarTagDictation',
    'SPCATEGORYTYPE', 'SVP_1', 'DISPID_SOTsItem', 'STCAll',
    'ISpeechBaseStream', 'SAFT11kHz8BitMono',
    'DISPID_SRCEventInterests', 'SRESoundEnd', 'SREPrivate',
    'SpObjectToken', 'SAFT44kHz16BitMono',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SOTCGetDataKey',
    'SAFTADPCM_11kHzMono', 'SpeechPropertyAdaptationOn',
    'SpeechAllElements', 'DISPID_SRCAudioInInterferenceStatus',
    'SVEWordBoundary', 'SRSActive', 'DISPID_SRCRecognizer',
    'SGSEnabled', 'DISPID_SRCRetainedAudio', 'SPEI_SR_PRIVATE',
    'SVP_3', '_ISpeechRecoContextEvents', 'SPINTERFERENCE_TOOQUIET',
    'SPEI_RESERVED6', 'DISPID_SRRSetTextFeedback',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SpeechPhraseRule',
    'SPPHRASEELEMENT', 'ISpNotifySink', 'SPFM_CREATE_ALWAYS',
    'DISPID_SPIAudioSizeTime', 'IEnumString', 'SPPS_Function',
    'IInternetSecurityMgrSite', 'SPEI_INTERFERENCE',
    'SPFM_OPEN_READONLY', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SP_VISEME_0', 'DISPID_SVSpeakStream',
    'SpeechAudioFormatGUIDText', 'DISPID_SRGRules', 'SPXRO_SML',
    'DISPID_SLWPronunciations', 'DISPID_SRAudioInputStream', 'SVP_6',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFTNonStandardFormat',
    'DISPID_SVEVoiceChange', 'DISPID_SVEViseme', 'eLEXTYPE_PRIVATE1',
    'SRSEIsSpeaking', 'DISPID_SRCERecognition', 'DISPID_SOTId',
    'SPEI_ADAPTATION', 'DISPID_SVEStreamStart', 'SPEI_MIN_SR',
    'SP_VISEME_10', 'SVP_2', 'SpTextSelectionInformation',
    'SPPARTOFSPEECH', 'DISPID_SpeechDataKey',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPEEngineConfidence', 'ISpeechResourceLoader',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPSSuppressWord', 'DISPID_SGRName',
    'DISPID_SVSLastBookmark', 'DISPID_SVSPhonemeId',
    'IInternetSecurityManager', 'SRSEDone', 'ISpeechRecoResultTimes',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRGDictationSetState',
    'SRCS_Enabled', 'DISPID_SLGetPronunciations',
    'ISpeechCustomStream', 'SVSFParseSapi', 'DISPID_SOTCategory',
    'DISPID_SGRSTType', 'SpShortcut', 'DISPID_SABIBufferSize',
    'DISPID_SpeechLexiconPronunciation', 'SPBOOKMARKOPTIONS',
    'SDKLCurrentConfig', 'ISpNotifyTranslator', 'SP_VISEME_13',
    'SPEI_END_INPUT_STREAM', 'DISPID_SpeechBaseStream',
    'DISPID_SVSyncronousSpeakTimeout', 'SPRS_ACTIVE_USER_DELIMITED',
    'SpeechFormatType', 'SpeechLexiconType',
    'SWPKnownWordPronounceable', 'SPEI_REQUEST_UI',
    'DISPID_SASetState', 'SpeechAudioFormatType',
    'DISPID_SpeechPhraseBuilder', 'SVSFDefault', 'SPEI_RESERVED5',
    'SPRST_ACTIVE_ALWAYS', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRGCommit', 'SPEI_RESERVED1', 'SVP_5',
    'DISPID_SMSSetData', 'SPEI_RECOGNITION', 'STSF_FlagCreate',
    'DISPID_SPPChildren', 'DISPID_SGRSRule', 'SAFT12kHz16BitStereo',
    'SpeechAudioFormatGUIDWave', 'DISPID_SpeechPhraseElements',
    'SAFT16kHz16BitMono', 'DISPID_SVESentenceBoundary',
    'SREPhraseStart', 'SAFT22kHz16BitMono', 'SDTAudio',
    'SpeechRecoContextState', 'DISPID_SRSetPropertyNumber',
    'SDTLexicalForm', 'SDA_Consume_Leading_Spaces',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRCESoundStart',
    'SAFTGSM610_8kHzMono', 'SVSFPersistXML', 'SAFT32kHz16BitMono',
    'DISPID_SPPValue', 'DISPID_SRProfile', 'SGSExclusive',
    'DISPID_SPAsCount', 'DISPID_SPEAudioStreamOffset', 'SPFM_CREATE',
    'SPVPRI_ALERT', 'DISPID_SpeechRecoResult', 'SPCT_COMMAND',
    'SpeechCategoryPhoneConverters', 'DISPID_SRCESoundEnd',
    'DISPID_SDKGetlongValue', 'DISPID_SDKDeleteValue',
    'eLEXTYPE_RESERVED10', 'ISequentialStream',
    'SpeechRecognizerState', 'DISPID_SRCEAudioLevel',
    'DISPID_SLGetWords', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPIReplacements', 'SVEPhoneme', 'SPSHORTCUTPAIRLIST',
    'SPEI_MIN_TTS', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRCEEnginePrivate', 'eLEXTYPE_PRIVATE3', 'SPVPRI_OVER',
    'ISpRecoGrammar2', 'DISPID_SPRules_NewEnum',
    'DISPID_SOTIsUISupported', 'SAFTCCITT_uLaw_8kHzStereo',
    'SGRSTTTextBuffer', 'SPAUDIOSTATE', 'DISPID_SpeechMMSysAudio',
    'eLEXTYPE_PRIVATE2', 'WAVEFORMATEX', 'SP_VISEME_15',
    'SSSPTRelativeToStart', 'DISPID_SRRAudioFormat', 'SLOStatic',
    'DISPID_SpeechPhraseAlternate', 'SAFTCCITT_ALaw_44kHzMono',
    'tagSTATSTG', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechVisemeFeature', 'SVP_20', 'DISPID_SRGetRecognizers',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SP_VISEME_1',
    'SpeechLoadOption', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPAR_Medium', 'SASRun', 'SpeechDictationTopicSpelling',
    'SRAORetainAudio', 'SPPS_Noun',
    'DISPID_SPANumberOfElementsInResult', 'SVP_12', 'SPAS_CLOSED',
    'SPPHRASEREPLACEMENT', 'ISpPhrase', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SPRFirstElement', 'tagSPTEXTSELECTIONINFO',
    ...
    'STSF_CommonAppData', 'DISPID_SRRAudio',
    'DISPID_SpeechCustomStream', 'SPXRO_Alternates_SML',
    'SRSInactiveWithPurge', 'DISPID_SPEs_NewEnum', 'SVP_7',
    'SAFT12kHz8BitMono', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SRCVoicePurgeEvent', 'eWORDTYPE_ADDED', 'ISpProperties',
    'SITooLoud', 'DISPID_SGRsItem', 'ISpeechPhraseRule',
    'SPEI_SR_AUDIO_LEVEL', 'SDA_No_Trailing_Space',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPRuleNumberOfElements',
    'SPEI_SOUND_START', 'ISpObjectToken', 'DISPID_SBSFormat',
    'SAFT48kHz8BitMono', 'SRAInterpreter', 'SDKLDefaultLocation',
    'SECFEmulateResult', 'DISPID_SRGIsPronounceable',
    'DISPID_SRSNumberOfActiveRules', 'SPSHT_Unknown',
    'STCLocalServer', 'SpeechPropertyResourceUsage',
    'ISpeechPhraseProperties', 'SPPS_Verb',
    'SpeechSpecialTransitionType', 'SDTRule', 'eLEXTYPE_PRIVATE9',
    ...
    'SPVOICESTATUS', 'SpeechCategoryAppLexicons',
    'DISPID_SpeechRecoResultTimes', 'SRTStandard',
    'DISPID_SRCEPropertyNumberChange', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPEVENTENUM', 'SPRECORESULTTIMES', 'DISPID_SRIsShared', 'SVP_16',
    'SPLOADOPTIONS', 'DISPID_SRCEPropertyStringChange', 'SREBookmark',
    'DISPID_SWFEBlockAlign', 'DISPID_SRGCmdSetRuleState',
    'ISpeechRecognizerStatus', 'DISPID_SPPNumberOfElements',
    'DISPID_SASFreeBufferSpace', 'SRAExport', 'SREHypothesis',
    'SPPS_Modifier', 'SPSLMA', 'SpeechRuleState',
    'SVSFParseAutodetect', 'DISPID_SpeechLexiconWord',
    'SpeechPropertyLowConfidenceThreshold', 'SP_VISEME_19',
    'DISPID_SRCEAdaptation', 'ISpRecoContext2',
    'DISPID_SRGDictationLoad', 'eLEXTYPE_VENDORLEXICON',
    'SSFMCreateForWrite', 'eLEXTYPE_APP', 'DISPID_SDKSetBinaryValue',
    'SVP_0', 'SpResourceManager', 'DISPID_SGRSTPropertyName',
    'DISPID_SRCResume', 'DISPID_SCSBaseStream',
    'DISPID_SpeechFileStream', 'DISPID_SLPLangId', 'SP_VISEME_12',
    'DISPID_SRCState', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpRecoResult', 'DISPID_SRGSetTextSelection',
    'SAFT24kHz16BitMono', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SAFT16kHz8BitStereo',
    'SRTReSent', 'DISPID_SGRInitialState', 'eLEXTYPE_PRIVATE17',
    'SPEI_END_SR_STREAM', 'SpeechCategoryVoices',
    'DISPID_SLAddPronunciation', 'DISPID_SPARecoResult',
    'ISpeechLexiconWord', 'DISPID_SRRRecoContext',
    'DISPID_SpeechAudioFormat', 'ISpRecoGrammar', 'DISPID_SVEPhoneme',
    'DISPID_SVWaitUntilDone', 'DISPID_SABufferInfo',
    'DISPID_SPCLangId', 'SRADynamic', 'DISPID_SPEPronunciation',
    'ISpeechLexiconPronunciations', 'ISpeechPhraseRules',
    'DISPID_SABufferNotifySize', 'eLEXTYPE_PRIVATE4', 'SASPause',
    'STCRemoteServer', 'SPWF_SRENGINE', 'SGDSActive',
    'DISPID_SpeechPhoneConverter', 'SPEI_SR_BOOKMARK',
    'DISPID_SAFType', 'ISpLexicon', 'eLEXTYPE_PRIVATE12',
    'SVEPrivate', 'SPVPRIORITY', 'DISPID_SPAs_NewEnum',
    'SpSharedRecognizer', 'ISpeechPhraseAlternates',
    'DISPID_SRCEEndStream', 'DISPID_SRRSpeakAudio',
    'DISPID_SVEAudioLevel', 'DISPID_SRRGetXMLErrorInfo',
    'SpMMAudioEnum', 'DISPID_SRCERecognizerStateChange', 'SWTAdded',
    'SpMMAudioOut', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SDKGetBinaryValue', 'DISPID_SOTs_NewEnum',
    'DISPID_SBSWrite', 'ISpeechXMLRecoResult', 'SPWT_DISPLAY',
    'eLEXTYPE_PRIVATE5', 'SECFDefault', 'DISPID_SpeechGrammarRules',
    'DISPID_SGRSTsItem', 'DISPID_SVSInputSentenceLength',
    'SECNormalConfidence', 'SPSHT_OTHER', 'SPSHORTCUTTYPE',
    'SITooQuiet', 'ISpVoice', 'SPSMF_SAPI_PROPERTIES',
    'SVSFPurgeBeforeSpeak', 'SpeechAudioProperties', 'SRSInactive',
    'SVSFParseMask', 'SPRULESTATE', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechPhraseRules', 'SP_VISEME_7',
    'SpeechRetainedAudioOptions', 'SREStreamEnd',
    'SAFT22kHz8BitStereo', 'DISPID_SGRsDynamic',
    'DISPID_SVAudioOutputStream', 'SDKLCurrentUser',
    'SDTPronunciation', 'SpeechStreamFileMode', 'SPRULE',
    'DISPID_SPRNumberOfElements', 'DISPID_SGRsFindRule',
    'DISPID_SPEsItem', 'ISpeechObjectTokens', 'DISPID_SRStatus',
    'SpMemoryStream', 'SpPhraseInfoBuilder', 'DISPID_SOTDataKey',
    'DISPID_SRCEBookmark', 'SAFT24kHz8BitStereo',
    'SpNotifyTranslator', 'SRERequestUI', 'ISpeechWaveFormatEx',
    'DISPID_SPPName', 'ISpRecognizer', 'ISpeechPhraseReplacements',
    'SpeechTokenShellFolder', 'SAFT32kHz16BitStereo',
    'DISPID_SGRSTNextState', 'SpNullPhoneConverter',
    'SVEStartInputStream', 'ISpRecognizer3', 'SPDATAKEYLOCATION',
    'SPCT_SLEEP', 'DISPID_SGRSTRule', 'SPPS_Unknown', 'SPWORDTYPE',
    'DISPID_SWFEExtraData', 'ISpSerializeState',
    'SpeechPropertyResponseSpeed', 'SVP_14', 'SPCONTEXTSTATE',
    'SpUnCompressedLexicon', 'DISPID_SpeechGrammarRuleState',
    'SVSFIsNotXML', 'DISPID_SRCERequestUI', 'SREAdaptation',
    'SpeechVisemeType', 'SP_VISEME_20', 'SPTEXTSELECTIONINFO',
    'SPEI_SOUND_END', 'DISPID_SPPsCount', 'Speech_Default_Weight',
    'SPAO_RETAIN_AUDIO', 'SPSInterjection', 'SVF_Emphasis',
    'ISpeechGrammarRule', 'DISPID_SPIGrammarId', 'eLEXTYPE_PRIVATE10',
    'DISPID_SAVolume', 'DISPID_SpeechRecoResult2',
    'DISPID_SMSGetData', 'DISPID_SDKEnumValues', 'SGSDisabled',
    'SpeechPropertyHighConfidenceThreshold', 'SPSModifier',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SGRSTWeight',
    'DISPID_SVSpeak', 'SPCT_SUB_DICTATION', 'DISPID_SLPsItem',
    'ISpShortcut', 'SP_VISEME_8', 'ISpXMLRecoResult',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPBO_PAUSE', '_ISpeechVoiceEvents',
    ...
    'SPINTERFERENCE_NOISE', 'SP_VISEME_4', 'DISPID_SVGetAudioInputs',
    'ISpeechPhraseInfo', 'DISPID_SpeechPhraseProperties',
    'ISpeechVoice', 'DISPID_SPPsItem', 'SECFIgnoreKanaType',
    'ISpeechMMSysAudio', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPIEngineId', 'SVSFlagsAsync', 'SECLowConfidence',
    'SVP_17', 'DISPID_SVGetVoices', 'SpSharedRecoContext',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SVSkip',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SpeechVoiceEvent', 'ISpeechVoiceStatus',
    'SpeechWordPronounceable', 'SPAS_RUN', 'SPAUDIOSTATUS',
    'ISpeechRecoGrammar', 'DISPID_SRCCreateResultFromMemory',
    'ISpeechPhraseReplacement', 'DISPID_SMSADeviceId',
    'ISpeechGrammarRuleStateTransitions', 'SAFT12kHz8BitStereo',
    'SGDisplay', 'ISpEventSink', 'DISPID_SDKEnumKeys',
    'SpPhoneConverter', 'SPVPRI_NORMAL', '_SPAUDIOSTATE',
    'DISPID_SVAlertBoundary', 'DISPID_SRSSupportedLanguages',
    'DISPIDSPTSI_ActiveLength', 'SPEI_TTS_BOOKMARK', 'SPEI_VISEME',
    ...
    'IEnumSpObjectTokens', 'SITooSlow', 'DISPID_SpeechLexiconProns',
    'SPGRAMMARWORDTYPE', 'SRATopLevel', 'SPLO_STATIC',
    'SpeechRecognitionType', 'tagSPPROPERTYINFO',
    ...
    'ISpeechAudioBufferInfo', 'SP_VISEME_21', 'SSSPTRelativeToEnd',
    'DISPID_SLPs_NewEnum', 'SPDKL_CurrentUser', 'SPEI_MAX_SR',
    'DISPID_SRCEHypothesis', 'SSTTWildcard', 'SAFTADPCM_44kHzMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpPhoneticAlphabetConverter', 'DISPID_SVAudioOutput',
    'DISPID_SOTCSetId', 'eLEXTYPE_USER',
    'DISPID_SGRSAddSpecialTransition', 'SAFTADPCM_22kHzStereo',
    'SP_VISEME_14', 'SP_VISEME_5', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVResume', 'SVPNormal', 'DISPID_SRGRecoContext',
    'ISpeechGrammarRuleStateTransition', 'SPAR_Unknown',
    'DISPID_SVSLastResult', 'DISPID_SPIStartTime',
    'DISPID_SRSCurrentStreamNumber', 'SAFT48kHz8BitStereo',
    'ISpeechPhoneConverter', 'eLEXTYPE_PRIVATE6',
    ...
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SVSInputWordPosition',
    'SPINTERFERENCE_TOOFAST', 'SRTSMLTimeout',
    'DISPID_SpeechPhraseProperty', 'DISPID_SpeechVoiceStatus',
    'ISpeechPhraseElement', 'DISPID_SGRClear', 'SGRSTTWord',
    'SAFT48kHz16BitMono', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SGRSTPropertyId', 'SP_VISEME_17', 'SGDSInactive',
    'DISPID_SRCCmdMaxAlternates', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SpeechRecognizer', 'SAFTGSM610_44kHzMono',
    'STCInprocServer', 'DISPID_SPIRetainedSizeBytes', 'SPGS_ENABLED',
    'ISpeechPhraseProperty', 'ISpeechObjectTokenCategory',
    'SPFM_OPEN_READWRITE', 'DISPID_SPEDisplayAttributes',
    'SAFT32kHz8BitStereo', 'SPSHT_EMAIL', 'DISPID_SVSVisemeId',
    'SINoSignal', 'ISpObjectWithToken', 'SVEBookmark',
    'DISPID_SPIGetText', 'DISPID_SPEActualConfidence',
    'SpeechMicTraining', 'ISpeechLexiconPronunciation',
    'SAFT44kHz16BitStereo', 'SVP_10', 'DISPID_SVEEnginePrivate',
    'SPEVENT', 'DISPID_SVGetAudioOutputs', 'SVP_15',
    'eLEXTYPE_RESERVED7', 'DISPID_SRCCreateGrammar', 'ISpPhraseAlt',
    'DISPID_SRCEStartStream', 'DISPID_SVEBookmark', 'SDTProperty',
    'SDTAll', 'SVP_9', 'SPRECOCONTEXTSTATUS', 'eLEXTYPE_RESERVED8',
    'SAFTGSM610_22kHzMono', 'DISPID_SLWsCount', 'DISPID_SPRuleName',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPPS_RESERVED1',
    'SRARoot', 'SpWaveFormatEx', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SLGenerationId', 'eLEXTYPE_PRIVATE15', 'DISPID_SGRId',
    'DISPID_SGRSAddWordTransition', 'DISPID_SVEStreamEnd',
    'SPPS_Noncontent', 'SECFIgnoreWidth', 'SRERecoOtherContext',
    'SRCS_Disabled', 'ISpPhoneConverter', 'SPRST_INACTIVE_WITH_PURGE',
    'SPBO_AHEAD', 'ISpeechFileStream', 'SSTTTextBuffer',
    ...
    'DISPID_SLAddPronunciationByPhoneIds', 'SVEEndInputStream',
    'DISPID_SPIProperties', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SFSOpen', 'DISPID_SPRuleChildren', 'SRSActiveAlways',
    'Speech_StreamPos_RealTime', 'SVEViseme', 'SpCustomStream',
    'DISPID_SVPause', 'SPEI_START_INPUT_STREAM', 'SPWORDLIST',
    'SSTTDictation', 'SAFTGSM610_11kHzMono',
    'DISPID_SVSInputWordLength', 'DISPID_SRRTOffsetFromStart',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechDataKeyLocation',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPWT_LEXICAL', 'DISPID_SFSClose',
    'DISPID_SPELexicalForm', 'SVP_13', 'DISPID_SRRTStreamTime',
    'DISPID_SGRSTransitions', 'DISPID_SLRemovePronunciation',
    'SAFT24kHz8BitMono', 'DISPID_SOTCEnumerateTokens',
    'SAFTADPCM_8kHzMono', 'SVSFParseSsml', 'SpFileStream',
    'SPWF_INPUT', 'ISpeechAudioStatus', 'DISPID_SPEAudioTimeOffset',
    ...
    'ISpeechDataKey', 'DISPID_SABIMinNotification', 'SREInterference',
    'SPRST_NUM_STATES', '_RemotableHandle',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SGRSTsCount',
    'SRTExtendableParse', 'SRTAutopause',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRCEFalseRecognition',
    'DISPID_SLWs_NewEnum', 'DISPID_SVRate', 'SGDSActiveUserDelimited',
    'SpeechPropertyNormalConfidenceThreshold', 'SPBINARYGRAMMAR',
    'DISPID_SRCPause', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SPPFirstElement', 'ISpeechRecoResult2', 'SVP_21',
    'SpeechVoiceSpeakFlags', 'ISpMMSysAudio', 'SAFTNoAssignedFormat',
    'SpeechInterference', 'SAFT16kHz16BitStereo', 'DISPID_SGRsAdd',
    'ISpRecognizer2', 'SECHighConfidence', 'ISpeechPhraseAlternate',
    'SpeechRunState', 'SpPhoneticAlphabetConverter',
    'SAFT24kHz16BitStereo', 'SAFT8kHz8BitMono', 'SPRST_ACTIVE',
    'SPRECOGNIZERSTATUS', 'SP_VISEME_6', 'DISPID_SPRuleFirstElement',
    'DISPID_SRAudioInput', 'DISPID_SRCreateRecoContext',
    'DISPID_SLPType', 'DISPID_SGRSTPropertyValue', 'ISpeechLexicon',
    'SPAO_NONE', 'SVF_Stressed', 'DISPID_SPPParent',
    'ISpeechPhraseElements', 'SpInProcRecoContext', 'SBONone',
    'DISPID_SpeechWaveFormatEx', 'SSFMCreate', 'SPAR_Low',
    'SpCompressedLexicon', 'ISpeechRecognizer',
    'DISPID_SRGCmdLoadFromMemory',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SLPSymbolic',
    'ISpAudio', 'SPEI_RECO_STATE_CHANGE', 'DISPID_SPRs_NewEnum',
    'SGRSTTEpsilon', 'eLEXTYPE_PRIVATE7', 'STCInprocHandler',
    'SpeechRecoEvents', 'SPPROPERTYINFO', 'SVP_11', 'DISPIDSPTSI',
    'SPWT_PRONUNCIATION', 'SPVISEMES', 'DISPID_SOTGetAttribute',
    'SPPS_NotOverriden', 'SRAImport', 'ISpEventSource',
    'SP_VISEME_11', 'SPPS_RESERVED4', 'DISPID_SVIsUISupported',
    'SPSEMANTICFORMAT', 'DISPID_SDKCreateKey', 'SAFT8kHz16BitMono',
    'DISPID_SADefaultFormat', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVSLastStreamNumberQueued', 'SFTSREngine', 'SVSFNLPMask',
    'DISPID_SPRuleConfidence', 'SPSNoun', 'SAFTDefault',
    'DISPID_SPPConfidence', 'SPRECOSTATE', 'DISPID_SPEsCount',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SASCurrentSeekPosition', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPRuleId', 'DISPID_SRRecognizer', 'SpeechAudioVolume',
    'SPRST_INACTIVE', 'DISPID_SOTGetStorageFileName',
    'DISPID_SPILanguageId', 'SPPS_RESERVED3', 'SPPS_LMA',
    'DISPID_SMSAMMHandle', 'SpeechTokenContext', 'SPAS_PAUSE',
    'SAFT12kHz16BitMono', 'DISPID_SWFEAvgBytesPerSec',
    'SECFIgnoreCase', 'DISPID_SpeechMemoryStream',
    'DISPID_SABIEventBias', 'SpeechGrammarTagUnlimitedDictation',
    'DISPIDSPTSI_SelectionLength', 'SpeechWordType',
    'ISpeechRecoResult', 'SPFILEMODE', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SpeechPhraseElement', 'DISPID_SPCPhoneToId',
    'DISPID_SGRSTText', 'DISPID_SRRTimes', 'DISPID_SRCEInterference',
    'DISPID_SAStatus', 'DISPID_SPEAudioSizeTime', 'SDKLLocalMachine',
    'SVEAudioLevel', 'DISPID_SPCIdToPhone', 'DISPID_SLWLangId',
    'SPSERIALIZEDRESULT', 'eLEXTYPE_PRIVATE8',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPEVENTSOURCEINFO',
    'SPEI_RESERVED2', 'SPINTERFERENCE_NONE', 'DISPID_SPAPhraseInfo',
    'SITooFast', 'DISPIDSPRG', 'DISPID_SPAsItem',
    'ISpeechRecoResultDispatch', 'Speech_Max_Pron_Length',
    'ISpRecoContext', 'DISPID_SVVolume', 'SPWAVEFORMATTYPE',
    'SDTReplacement', 'DISPID_SPAStartElementInResult',
    'SAFTADPCM_22kHzMono', 'SPSTREAMFORMATTYPE', 'DISPID_SPPId',
    'SAFT44kHz8BitMono', 'SAFT8kHz8BitStereo', 'SP_VISEME_2',
    'DISPID_SLPsCount', 'SP_VISEME_9', 'SpObjectTokenCategory',
    'SDA_One_Trailing_Space', 'SpeechCategoryRecoProfiles',
    'DISPID_SRSClsidEngine', 'UINT_PTR',
    'ISpeechTextSelectionInformation', 'SPINTERFERENCE',
    'DISPID_SpeechRecoContextEvents', 'ISpeechRecoContext',
    'eLEXTYPE_RESERVED6', 'DISPID_SRCEPhraseStart', 'DISPID_SLWsItem',
    'SpInprocRecognizer', 'SPWORDPRONUNCIATION', 'LONG_PTR',
    'DISPID_SRGId', 'SPBO_TIME_UNITS', 'SPCS_ENABLED',
    'SPCS_DISABLED', 'SAFT22kHz16BitStereo', 'SAFT16kHz8BitMono',
    'SPEI_MAX_TTS', 'DISPID_SRGDictationUnload',
    'SPEI_RECO_OTHER_CONTEXT', 'SINoise', 'SINone',
    'DISPID_SpeechAudio', 'SDTAlternates',
    'DISPID_SpeechObjectTokens', 'SpeechDisplayAttributes',
    'DISPID_SOTCId', 'DISPID_SVVoice', 'SpeechVoiceEvents',
    'Speech_Max_Word_Length', 'DISPID_SpeechAudioStatus',
    'DISPID_SpeechLexiconWords', 'DISPID_SREmulateRecognition',
    'SPPHRASERULE', 'SLTUser', 'DISPID_SVGetProfiles', 'SPAS_STOP',
    'SRAONone', 'DISPID_SPRText', 'SAFTCCITT_ALaw_8kHzMono',
    'SpLexicon', 'SVP_8', 'SWTDeleted', 'DISPID_SVPriority',
    'DISPID_SRGCmdLoadFromResource', 'SPSFunction',
    'SAFT11kHz16BitMono', 'SVSFNLPSpeakPunc', 'SpeechCategoryAudioIn',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SVSLastBookmarkId', 'SpeechEmulationCompareFlags',
    'SPSVerb', 'DISPID_SRGetFormat', 'DISPID_SDKDeleteKey',
    'DISPID_SRIsUISupported', 'DISPID_SPIRule',
    'ISpeechGrammarRuleState', 'SWPUnknownWordPronounceable',
    'DISPID_SWFEChannels', 'SBOPause', 'DISPID_SPEDisplayText',
    'eLEXTYPE_PRIVATE11', 'eLEXTYPE_PRIVATE20',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SASState', 'SP_VISEME_3',
    'ISpeechAudio', 'DISPID_SpeechRecoContext', 'SVP_18',
    'SpeechGrammarWordType', 'SGLexical', 'DISPID_SpeechGrammarRule',
    'DISPID_SDKSetStringValue', 'DISPID_SPERetainedStreamOffset',
    'SpeechAudioState', 'ISpGrammarBuilder',
    'DISPID_SVSCurrentStreamNumber', 'SRTEmulated',
    'SpeechGrammarState', 'SPXMLRESULTOPTIONS', 'SVSFIsXML',
    'SpeechTokenKeyFiles', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpAudioFormat', 'SAFT48kHz16BitStereo',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SPISaveToMemory',
    'DISPID_SVEWord', 'SAFT11kHz16BitStereo',
    'SREPropertyStringChange', 'SPRS_ACTIVE',
    'DISPID_SpeechPhraseAlternates', 'SPGS_DISABLED',
    'DISPID_SBSSeek', 'SAFT22kHz8BitMono', 'ISpDataKey',
    'SVSFIsFilename', 'DISPID_SPRsCount',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SVEventInterests',
    'SVSFUnusedFlags', 'SVPOver', 'Speech_StreamPos_Asap',
    'DISPID_SpeechLexicon', 'SREAllEvents',
    ...
    'SPEI_PHRASE_START', 'SASClosed',
    'DISPID_SpeechPhraseReplacement', 'SpStream',
    'SpeechVoicePriority', 'SPPHRASE', 'DISPID_SRGCmdSetRuleIdState',
    'SPGRAMMARSTATE', 'SPEI_RESERVED3', 'SPAUDIOBUFFERINFO',
    'DISPID_SPACommit', 'SREAudioLevel', 'DISPID_SPIAudioSizeBytes',
    'SPGS_EXCLUSIVE', 'SVEVoiceChange', 'DISPID_SOTRemove',
    'SPPHRASEPROPERTY', 'SASStop', 'DISPID_SRGetPropertyNumber',
    'DISPID_SLPPhoneIds', 'eWORDTYPE_DELETED', 'SAFTADPCM_8kHzStereo',
    'SpeechTokenKeyUI', 'SFTInput', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPLO_DYNAMIC',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechRegistryUserRoot',
    'DISPID_SOTGetDescription', 'SPEI_START_SR_STREAM',
    'DISPID_SRGetPropertyString', 'SVPAlert',
    'DISPID_SVSpeakCompleteEvent', 'SPDKL_DefaultLocation',
    'SPEI_FALSE_RECOGNITION', 'SREStreamStart', 'SPDKL_CurrentConfig',
    'DISPID_SPPEngineConfidence', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpeechMemoryStream', 'SAFTADPCM_44kHzStereo', 'SPEI_PHONEME',
    'DISPID_SLGetGenerationChange', 'DISPID_SAEventHandle',
    'DISPID_SPRsItem', 'SSFMOpenReadWrite', 'SVP_19',
    'SGRSTTWildcard', 'DISPID_SOTDisplayUI', 'SpeechDiscardType',
    'DISPID_SGRAddState', 'SpVoice', 'SpeechCategoryAudioOut',
    'SPSHORTCUTPAIR', 'ISpStreamFormatConverter',
    'SPINTERFERENCE_TOOLOUD', 'SpeechBookmarkOptions',
    'SPCT_DICTATION', 'ISpeechObjectToken', 'SPCT_SUB_COMMAND',
    'DISPID_SLWType', 'DISPID_SGRsCount', 'DISPID_SOTSetId',
    'DISPID_SBSRead', 'SPEI_UNDEFINED', 'SPEI_VOICE_CHANGE', 'SPWORD',
    'DISPID_SPRulesCount', 'SWPUnknownWordUnpronounceable',
    'DISPIDSPTSI_SelectionOffset', 'SPSUnknown', 'ISpStream',
    'DISPID_SRRSaveToMemory', 'SPEI_TTS_PRIVATE',
    'SpStreamFormatConverter', 'DISPID_SRGState', 'SRERecognition',
    'DISPID_SOTRemoveStorageFileName', 'SDTDisplayText',
    'SpeechStreamSeekPositionType', 'DISPID_SVDisplayUI',
    'SPINTERFERENCE_TOOSLOW', 'SP_VISEME_16', 'eLEXTYPE_PRIVATE16',
    'SPPS_RESERVED2', 'ISpeechGrammarRules', 'SPBO_NONE',
    'SRADefaultToActive', 'ISpeechAudioFormat', 'ISpResourceManager',
    'SPAUDIOOPTIONS', 'SpeechEngineProperties',
    'DISPID_SPIGetDisplayAttributes', 'SECFNoSpecialChars',
    'DISPID_SRCBookmark', 'eLEXTYPE_PRIVATE14', 'SpeechPartOfSpeech',
    'DISPID_SGRAttributes', 'eLEXTYPE_RESERVED9',
    'DISPID_SPERequiredConfidence', 'DISPID_SpeechPhraseInfo',
    'SAFT44kHz8BitStereo', 'DISPID_SRRTTickCount',
    'SAFTADPCM_11kHzStereo', 'SGRSTTDictation', 'SPFM_NUM_MODES',
    'SPEI_HYPOTHESIS', 'DISPID_SpeechPhraseReplacements',
    'ISpNotifySource', 'SPSMF_UPS', 'SPAR_High',
    'DISPID_SVSInputSentencePosition', 'SAFT32kHz8BitMono',
    'eLEXTYPE_PRIVATE19', 'SVF_None', 'SLTApp', 'SpMMAudioIn',
    'DISPID_SDKOpenKey', 'SPSERIALIZEDPHRASE', 'SSFMOpenForRead',
    'SPPS_Interjection', 'SAFTCCITT_uLaw_44kHzStereo',
    'SGPronounciation', 'SpeechCategoryRecognizers', 'SVSFVoiceMask',
    'SPEI_SR_RETAINEDAUDIO', 'eLEXTYPE_PRIVATE13',
    'eLEXTYPE_PRIVATE18', 'SPSEMANTICERRORINFO', 'DISPID_SVStatus',
    'SGLexicalNoSpecialChars', 'SPSNotOverriden',
    'DISPID_SPRuleParent', 'eLEXTYPE_RESERVED4', 'SLODynamic',
    'SpeechTokenKeyAttributes', 'SPDKL_LocalMachine',
    'SpeechGrammarTagWildcard', 'SREPropertyNumChange',
    'SpeechRecoProfileProperties', 'DISPID_SOTCDefault',
    'DISPID_SRRGetXMLResult', 'DISPID_SDKSetLongValue',
    'DISPID_SGRSTs_NewEnum', 'SVP_4', 'SPINTERFERENCE_NOSIGNAL'
]

_check_version('1.1.13', 1652218003.741873)
